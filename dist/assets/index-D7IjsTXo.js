...
function ku(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ra), co(e);
  var u = n.contextType;
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    xr(e, n), la(n, t, r), ku(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function ad(e, n, t) {
  ...
  switch ((lo(n), n.tag)) {
    ...
    case 4:
      return (
        et(), Nu(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[vu], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
hs = _o;
ys = zn;
var zd = { usingClientEntryPoint: !1, Events: [Zt, jn, ll, ms, vs, _o] },
  vt = {
...
var Td = qi.exports,
  nc,
  Vi = Td;
(nc = Vi.createRoot), Vi.hydrateRoot;
function Rd() {
  return St.jsx("div", {
    id: "app-root",
    children: St.jsx("div", {
      className: "layout",
      children: St.jsx("h1", { children: "Cards!" }),
    }),
  });
}
function Od() {
  const e = document.getElementById("static-page");
  e && (e.innerHTML = "");
  const n = document.querySelector("#cards-webapp-react");
  if (!n)
    throw Error("Can not find a container for the app: #cards-webapp-react");
  nc(n).render(St.jsx(wc.StrictMode, { children: St.jsx(Rd, {}) }));
}
Od();
